...
namespace eosio {
   ...
   class mw : public contract {
      public:
         mw( account_name self ):contract(self){}
   ...
   asset mw::get_supply( symbol_name sym )const
   {
   ...
   asset mw::get_balance( account_name owner, symbol_name sym )const
   {
